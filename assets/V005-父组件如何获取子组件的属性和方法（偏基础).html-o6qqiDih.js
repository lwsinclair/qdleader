import{_ as n,c as a,a as e,o as l}from"./app-CYLYNC8L.js";const t={};function p(i,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="v005-父组件如何获取子组件的属性和方法" tabindex="-1"><a class="header-anchor" href="#v005-父组件如何获取子组件的属性和方法"><span>V005-父组件如何获取子组件的属性和方法</span></a></h1><p>vue中通过在子组件上定义ref属性来获取子组件的属性和方法，</p><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line"><span class="token comment">// 这里是父组件</span></span>
