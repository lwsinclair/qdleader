import{_ as s,c as n,a,o as l}from"./app-CYLYNC8L.js";const i={};function t(c,e){return l(),n("div",null,[...e[0]||(e[0]=[a(`<p>?用法</p><p>除了表示可选参数外，常用于防御性编程</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">const a = fetch(...) || {}		// 假设a是从后端拿到的一个对象类型数据</span>
