import{_ as n,c as a,a as p,o as e}from"./app-CYLYNC8L.js";const t={};function l(i,s){return e(),a("div",null,[...s[0]||(s[0]=[p(`<h2 id="配置提交规范" tabindex="-1"><a class="header-anchor" href="#配置提交规范"><span>配置提交规范</span></a></h2><p>npm i -D husky</p><p>npx husky install</p><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line"><span class="token comment">// @see: https://cz-git.qbenben.com/zh/guide</span></span>
