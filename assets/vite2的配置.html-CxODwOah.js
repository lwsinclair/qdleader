import{_ as n,c as e,a,o as i}from"./app-CYLYNC8L.js";const l={};function d(p,s){return i(),e("div",null,[...s[0]||(s[0]=[a(`<h1 id="vite2的配置" tabindex="-1"><a class="header-anchor" href="#vite2的配置"><span>vite2的配置</span></a></h1><p>创建项目</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line"># 如果需要交互式命令创建</span>
