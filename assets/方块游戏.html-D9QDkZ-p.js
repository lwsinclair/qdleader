import{_ as n,c as a,a as p,o as e}from"./app-CYLYNC8L.js";const l={};function o(c,s){return e(),a("div",null,[...s[0]||(s[0]=[p(`<h1 id="方块游戏" tabindex="-1"><a class="header-anchor" href="#方块游戏"><span>方块游戏</span></a></h1><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line">请帮我创建一个色块识别小挑战游戏，这是一个纯<span class="token constant">HTML</span>前端项目：玩家需要在网格中找出颜色不同的那一个色块。游戏包含<span class="token number">100</span>个关卡，分为<span class="token number">6</span>个难度阶段，具有完整的计分系统、排行榜和成就系统。</span>
