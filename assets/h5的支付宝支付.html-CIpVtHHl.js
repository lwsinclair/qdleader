import{_ as n,c as a,a as e,o as i}from"./app-CYLYNC8L.js";const l={};function d(c,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="h5的支付宝支付" tabindex="-1"><a class="header-anchor" href="#h5的支付宝支付"><span>h5的支付宝支付</span></a></h1><p>h5吊起支付宝app支付 （前端实现）</p><p>后端按照支付宝官网会返回一个form表单</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">// 支付宝H5支付</span>
