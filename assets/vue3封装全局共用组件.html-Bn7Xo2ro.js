import{_ as n,c as e,a,o as l}from"./app-CYLYNC8L.js";const i={};function t(p,s){return l(),e("div",null,[...s[0]||(s[0]=[a(`<h1 id="vue3封装全局共用组件" tabindex="-1"><a class="header-anchor" href="#vue3封装全局共用组件"><span>vue3封装全局共用组件</span></a></h1><p>很简单其实， 比如我们来封装一个empty 空状态的组件</p><p>先写个 empty.vue</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">&lt;template&gt;</span>
