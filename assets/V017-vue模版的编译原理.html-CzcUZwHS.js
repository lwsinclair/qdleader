import{_ as s,c as n,a,o as i}from"./app-CYLYNC8L.js";const l={};function t(d,e){return i(),n("div",null,[...e[0]||(e[0]=[a(`<h1 id="v017-vue-模版的编译原理" tabindex="-1"><a class="header-anchor" href="#v017-vue-模版的编译原理"><span>V017-vue 模版的编译原理</span></a></h1><h2 id="vue-模板编译原理" tabindex="-1"><a class="header-anchor" href="#vue-模板编译原理"><span>Vue 模板编译原理</span></a></h2><p>Vue 的编译过程就是将 template 转化为 render 函数的过程 分为以下三步</p><blockquote><p>第一步是将 模板字符串 转换成 element ASTs 语法树 （解析器） 第二步是对 AST 进行静态节点标记，主要用来做虚拟 DOM 的渲染优化（优化器） 第三步是 使用 element ASTs 生成 render 函数代码字符串（代码生成器）</p></blockquote><p>相关代码如下</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">export function compileToFunctions(template) {</span>
