import{_ as e,c as t,a as p,o as h}from"./app-CYLYNC8L.js";const n={};function r(d,a){return h(),t("div",null,[...a[0]||(a[0]=[p(`<h1 id="http2-0-及-http3-0-有哪些改进" tabindex="-1"><a class="header-anchor" href="#http2-0-及-http3-0-有哪些改进"><span>http2.0 及 http3.0 有哪些改进</span></a></h1><h2 id="一、http-1-0" tabindex="-1"><a class="header-anchor" href="#一、http-1-0"><span>一、HTTP/1.0</span></a></h2><p>1996 年 5 月，HTTP/1.0 版本发布，为了提高系统的效率，HTTP/1.0 规定浏览器与服务器只保持短暂的连接，浏览器的每次请求都需要与服务器建立一个 TCP 连接，服务器完成请求处理后立即断开 TCP 连接，服务器不跟踪海个客户也不记录过去的请求。 请注意上面提到的 HTTP/1.0 中浏览器与服务器只保持短暂的连接，连接无法复用。也就是说每个 TCP 连接只能发送一个请求。发送数据完毕，连接就关闭，如果还要请求其他资源，就必须再新建一个连接。 我们知道 TCP 连接的建立需要三次握手，是很耗费时间的一个过程。所以，HTTP/1.O 版本的性能比较差。现在，随便打开一个网页，上面都会有很多图片、视频等资源，HTTP/1.0 显然无法满足性能要求。</p><h2 id="二、http-1-1" tabindex="-1"><a class="header-anchor" href="#二、http-1-1"><span>二、HTTP/1.1</span></a></h2><h3 id="_1、持久连接" tabindex="-1"><a class="header-anchor" href="#_1、持久连接"><span>1、持久连接</span></a></h3><pre><code>HTTP/1.0 中一个 TCP 连接只能发送一个请求和响应，而 HTTP/1.1 进行了优化，同一个 TCP 连接可以发送多次 HTTP 请求，减少了建立和关闭连接的性能开销。
