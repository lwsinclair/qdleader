import{_ as n,c as a,a as p,o as e}from"./app-CYLYNC8L.js";const t={};function l(i,s){return e(),a("div",null,[...s[0]||(s[0]=[p(`<h1 id="v001-vuex实用篇" tabindex="-1"><a class="header-anchor" href="#v001-vuex实用篇"><span>V001-vuex实用篇</span></a></h1><h2 id="_1-首先在main-js中引入" tabindex="-1"><a class="header-anchor" href="#_1-首先在main-js中引入"><span>1.首先在main.js中引入</span></a></h2><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line"><span class="token keyword">import</span> store <span class="token keyword">from</span> <span class="token string">&#39;./store/index.js&#39;</span></span>
