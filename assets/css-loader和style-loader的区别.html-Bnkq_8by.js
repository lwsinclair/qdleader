import{_ as n,c as a,a as p,o as e}from"./app-CYLYNC8L.js";const l={};function t(c,s){return e(),a("div",null,[...s[0]||(s[0]=[p(`<h1 id="css-loader和style-loader的区别" tabindex="-1"><a class="header-anchor" href="#css-loader和style-loader的区别"><span>css-loader和style-loader的区别</span></a></h1><div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line">webpack是用<span class="token constant">JS</span>写的，运行在node环境，所以默认webpack打包的时候只会处理<span class="token constant">JS</span>之间的依赖关系。</span>
