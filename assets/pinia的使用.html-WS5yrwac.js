import{_ as n,c as a,a as e,o as i}from"./app-CYLYNC8L.js";const l={};function t(c,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="pinia的使用" tabindex="-1"><a class="header-anchor" href="#pinia的使用"><span>pinia的使用</span></a></h1><h2 id="安装状态管理pinia" tabindex="-1"><a class="header-anchor" href="#安装状态管理pinia"><span>安装状态管理pinia</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line"> npm install pinia</span>
